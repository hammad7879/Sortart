...
export const metadata: Metadata = {
  ...
  description:
    'A premium AI companion for artists. Get color analysis, mixing guides, and expert coaching for your artwork.',
  icons: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${playfairDisplay.variable} ${crimsonPro.variable} font-sans antialiased`}
      >
